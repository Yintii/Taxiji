...
class WalletsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wallet" do
    assert_difference("Wallet.count") do
      post wallets_url, params: { wallet: { wallet_address: @wallet.wallet_address, wallet_name: @wallet.wallet_name } }
    end
  ...
  test "should update wallet" do
    patch wallet_url(@wallet), params: { wallet: { wallet_address: @wallet.wallet_address, wallet_name: @wallet.wallet_name } }
